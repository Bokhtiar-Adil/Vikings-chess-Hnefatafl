...
class Game_manager:
    ...
    def match_finished(self):
        ...
        for row in self.current_board_status:
            for column in row:
                if column[0] == "a":
                    attackers += 1
                elif column[0] == "d":
        ...
        if self.king_captured:
            ...
            consolas2 = pg.font.SysFont("consolas", 20)
            write_text("Remaining Pieces:", self.screen, (WINDOW_WIDTH - 250, BOARD_TOP +
                       SETTINGS_TEXT_GAP_VERTICAL*5), (255, 255, 255), consolas, False)
            write_text("Attackers: " + str(attackers), self.screen, (WINDOW_WIDTH - 300, BOARD_TOP + SETTINGS_TEXT_GAP_VERTICAL*6),
                       (255, 255, 255), consolas2, False)
            write_text("Defenders: " + str(defenders), self.screen, (WINDOW_WIDTH - 300, BOARD_TOP + SETTINGS_TEXT_GAP_VERTICAL*7),
                       (255, 255, 255), consolas2, False)
            if self.mode == 0:
            ...
            write_text("Attackers: " + str(attackers), self.screen, (WINDOW_WIDTH - 300, BOARD_TOP + SETTINGS_TEXT_GAP_VERTICAL*6),
                       (255, 255, 255), consolas2, False)
            write_text("Defenders: " + str(defenders) + " and King", self.screen, (WINDOW_WIDTH - 300, BOARD_TOP + SETTINGS_TEXT_GAP_VERTICAL*7),
                       (255, 255, 255), consolas2, False)
    ...
    def turn_msg(self, game_started):
        ...
        consolas2 = pg.font.SysFont("consolas", 20)
        write_text("Remaining Pieces:", self.screen, (WINDOW_WIDTH - 250, BOARD_TOP +
                   SETTINGS_TEXT_GAP_VERTICAL*5), (255, 255, 255), consolas2, False)
        write_text("Attackers: " + str(attackers), self.screen, (WINDOW_WIDTH - 300,
                   BOARD_TOP + SETTINGS_TEXT_GAP_VERTICAL*6), (255, 255, 255), consolas2, False)
        write_text("Defenders: " + str(defenders) + " and King", self.screen, (WINDOW_WIDTH -
                   300, BOARD_TOP + SETTINGS_TEXT_GAP_VERTICAL*7), (255, 255, 255), consolas2, False)
        consolas = pg.font.SysFont("consolas", 22)
        if not game_started:
            if self.mode == 0:
...
class AI_manager:
    ...
    def __init__(self, manager, screen, max_depth = 3):
...
def game_window(screen, mode):
    ...
    while tafle:
        ...
        write_text("AI Level:", screen, (WINDOW_WIDTH - 300, BOARD_TOP + SETTINGS_TEXT_GAP_VERTICAL*2.5 + 10), (255, 255, 255),
                   pg.font.SysFont("Arial", 20), False)

        easybtn = Custom_button(WINDOW_WIDTH - 300 + SETTINGS_TEXT_GAP_HORIZONTAL, BOARD_TOP +
                                SETTINGS_TEXT_GAP_VERTICAL*2.5, "Easy", screen, pg.font.SysFont("Arial", 20), width=50, height=50)

        hardbtn = Custom_button(WINDOW_WIDTH - 300 + SETTINGS_TEXT_GAP_HORIZONTAL*1.7, BOARD_TOP +
                                SETTINGS_TEXT_GAP_VERTICAL*2.5, "Hard", screen, pg.font.SysFont("Arial", 20), width=50, height=50)
        ...
        if easybtn.draw_button():
            if mode == 1:
                bot.max_depth = 1

        if hardbtn.draw_button():
            if mode == 1:
                bot.max_depth = 3
...
def rules(screen):
    ...
    while tafle:
        ...
        cnt = 0
        for msg in msgs:
            write_text(msg, screen, (20, BOARD_TOP - 80 + 40*cnt),
                       white, consolas, False)
            cnt += 1
